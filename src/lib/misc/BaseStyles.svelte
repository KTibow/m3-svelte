...
.m3-font-display-large, .m3-font-display-medium, .m3-font-display-small {
  font-family: var(--m3-font-display, Roboto, system-ui, sans-serif);
...
.m3-font-headline-large, .m3-font-headline-medium, .m3-font-headline-small {
  font-family: var(--m3-font-headline, Roboto, system-ui, sans-serif);
...
.m3-font-title-large, .m3-font-title-medium, .m3-font-title-small {
  font-family: var(--m3-font-title, Roboto, system-ui, sans-serif);
...
.m3-font-label-large, .m3-font-label-medium, .m3-font-label-small {
  font-family: var(--m3-font-label, Roboto, system-ui, sans-serif);
...
.m3-font-body-large, .m3-font-body-medium, .m3-font-body-small {
  font-family: var(--m3-font-body, Roboto, system-ui, sans-serif);
