...
const relevantLinks: { title: string; link: string }[] = [{"title":"DateField.svelte","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/forms/DateField.svelte"},{"title":"DateFieldOutlined.sv","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/forms/DateFieldOutlined.svelte"}];
</script>
