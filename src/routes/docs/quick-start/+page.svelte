...
[your theme snippet]`}
        ...
        {:else}
          <p>
            If you want to lower your bundle size, manually adding the styles is an option. While
            this means you only send the styles once, it isn't recommended.
          </p>
          <p>
