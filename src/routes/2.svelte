...
const minimalDemo = `${"<"}SplitButton variant="filled" onclick={() => alert("!")}>
  ...
  {/snippet}
${"<"}/SplitButton>`;
const relevantLinks: { title: string; link: string }[] = [{"title":"SplitButton.sv","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/buttons/SplitButton.svelte"},{"title":"Menu.svelte","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/containers/Menu.svelte"},{"title":"MenuItem.svelte","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/containers/MenuItem.svelte"}];
</script>
