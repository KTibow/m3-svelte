...
const minimalDemo = `${"<"}Select
  ...
  bind:value
/>`;
const relevantLinks: { title: string; link: string }[] = [{"title":"Select.svelte","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/forms/Select.svelte"},{"title":"SelectOutlined.sv","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/forms/SelectOutlined.svelte"}];
</script>
