...
${"<"}/Menu>`;
const relevantLinks: { title: string; link: string }[] = [{"title":"Menu.svelte","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/containers/Menu.svelte"},{"title":"MenuItem.svelte","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/containers/MenuItem.svelte"}];
</script>
