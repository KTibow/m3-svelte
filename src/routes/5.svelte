...
const minimalDemo = `${"<"}div>
  ...
  ${"<"}ListItem headline="Hello" />
${"<"}/div>`;
const relevantLinks: { title: string; link: string }[] = [{"title":"ListItem.svelte","link":"https://github.com/KTibow/m3-svelte/blob/main/src/lib/containers/ListItem.svelte"}];
</script>
