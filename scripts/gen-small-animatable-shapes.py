...
smooth_shapes = {
    ...
    "pathSquare": all_shapes["pathSquare"],
    "pathSlanted": all_shapes["pathSlanted"],
    "pathArch": all_shapes["pathArch"],
    "pathFan": all_shapes["pathFan"],
    "pathArrow": all_shapes["pathArrow"],
    "pathSemicircle": all_shapes["pathSemicircle"],
    "pathOval": all_shapes["pathOval"],
    "pathPill": all_shapes["pathPill"],
    "pathTriangle": all_shapes["pathTriangle"],
    "pathDiamond": all_shapes["pathDiamond"],
    "pathClamshell": all_shapes["pathClamshell"],
    "pathPentagon": all_shapes["pathPentagon"],
    "pathGem": all_shapes["pathGem"],
    "pathVerySunny": all_shapes["pathVerySunny"],
    ...
    "pathGhostish": all_shapes["pathGhostish"],
    ...
    "pathBun": all_shapes["pathBun"],
    "pathHeart": all_shapes["pathHeart"],
}
